                ...
                <div class="import">
                    ...
                    <form class="import__vectors-form" @submit="$event.preventDefault()">
                        <div class="buttons-div">
                          <input type="text" id="file-name" class="import__vectors-form__file-name" readonly />
                          <input type="file" id="file-upload" class="import__vectors-form__input" accept=".csv" @change="displayCsvDataInTextArea"/>
...
<style lang="scss" scoped>
    ...
    .import__vectors-form__file-name {
      width: 300px;
      height: 43px;
      padding: 10px;
      border-top: none;
